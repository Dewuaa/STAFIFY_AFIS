...
<style>
    ...
    .icon-investment { background-color: var(--success-light); color: var(--success-color); }
    .icon-withdrawal { background-color: var(--danger-light); color: var(--danger-color); }
    .icon-equity { background-color: var(--primary-light); color: var(--primary-color); }
    ...
    .transaction-table { width: 100%; border-collapse: collapse; font-size: 14px; min-width: 800px; }
