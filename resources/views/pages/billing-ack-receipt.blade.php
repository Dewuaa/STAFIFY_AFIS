...
@push('styles')
    <style>
        ...
        .ack-receipt-page { padding: 0; max-width: 100%; margin: 0 auto; }
        ...
        .content-card {
            ...
            box-shadow: var(--box-shadow); overflow: hidden; padding: 24px;
        }
        ...
        .receipts-table th, .receipts-table td { padding: 12px 16px; text-align: left; border-bottom: 1px solid var(--border-color); color: var(--text-color); font-size: 14px; }
        .receipts-table th { background-color: #f8f9fa; color: var(--text-color-light); font-weight: 600; font-size: 12px; text-transform: uppercase; }
        .receipts-table tr:hover { background-color: var(--secondary-color); }
        .receipts-table .action-buttons { display: flex; gap: 8px; justify-content: flex-start; }
        ...
        .icon-receipts { background-color: var(--primary-light); color: var(--primary-color); } /* FIX: var(--primary-light) used here */
        .icon-pending { background-color: #fef3c7; color: var(--warning-color); }
        .icon-received { background-color: #d1fae5; color: #065f46; }
        ...
        .modal-content {
            ...
            box-shadow: 0 10px 25px rgba(0, 0, 0, 0.2); width: 90%; max-height: 90vh; overflow-y: auto;
        ...
        /* --- 9. Receipt Create/Edit Layout --- */
        .receipt-modal-layout { display: flex; gap: 30px; }
        .receipt-form-pane { flex: 1; min-width: 400px; }
        ...
        .receipt-preview-content { position: relative; z-index: 2; }
        .receipt-preview-pane::before {
             ...
             background-repeat: no-repeat; background-size: contain; opacity: 0.08; z-index: 1; pointer-events: none;
        }
        
        /* --- 10. View & Preview Styles --- */
        .invoice-view-actions { margin-bottom: 24px; padding: 16px; background: var(--white); border-radius: var(--border-radius); box-shadow: var(--box-shadow); display: flex; flex-wrap: wrap; gap: 12px; }
        ...
        .receipt-header { display: flex; justify-content: space-between; margin-bottom: 20px; flex-wrap: wrap; gap: 16px; }
        .receipt-header .company-info { font-size: 14px; line-height: 1.6; text-align: left; }
        .receipt-header .receipt-meta { text-align: right; font-size: 14px; flex-shrink: 0; }
        .receipt-meta p { margin: 0 0 5px 0; }
        .receipt-meta .receipt-id { font-weight: bold; font-size: 1.1em; }

        .receipt-statement { margin: 24px 0; font-size: 15px; line-height: 1.7; text-align: left; }
        .receipt-statement .highlight { font-weight: 700; color: var(--primary-color); }

        .receipt-details-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 24px; font-size: 14px; line-height: 1.6; }
        .receipt-details-box { background: #f8f9fa; border: 1px solid var(--border-color); padding: 16px; border-radius: var(--border-radius); text-align: left; }
        .receipt-details-box p { margin: 0 0 8px 0; }
        
        .receipt-notes { margin-top: 24px; font-size: 14px; line-height: 1.6; text-align: left; }
        .receipt-signatures { margin-top: 60px; display: flex; justify-content: space-between; font-size: 14px; }
        .signature-box { width: 45%; text-align: center; padding-top: 10px; border-top: 1px solid #999; }
        .receipt-signed-badge { color: var(--success-color); font-weight: bold; }
        ...
        .success-message { background-color: #d4edda; color: #155724; padding: 15px; border-radius: var(--border-radius); margin-bottom: 20px; }

        /* --- 12. RESPONSIVE ADJUSTMENTS (FIXED) --- */
        @media (max-width: 992px) {
            /* Stack the modal content */
            .receipt-modal-layout { flexDirection: column; }
            .receipt-form-pane { min-width: 100%; }
            .receipt-preview-pane { max-height: none; margin-top: 20px; }
        }
        ...
        @media (max-width: 768px) {
            ...
            .receipts-table { min-width: 800px; } /* Force scroll */
            ...
            .receipt-modal-layout { flex-direction: column; gap: 20px; }
            .receipt-form-pane { min-width: 100%; }
            ...
            .receipt-signatures { flex-direction: column; gap: 40px; }
...
Stafffy Inc</textarea>
                ...
                <div style="margin-top: 15px; display: flex; flex-direction: column; gap: 10px;">
                    ...
                    <label style="flex-direction: row; align-items: center; display: flex;">
                        <input type="checkbox" name="request_signature" checked style="width: auto; margin-right: 10px;"> Request customer to sign
                    </label>
                </div>
            ...
            <form method="POST" action="{{ $editId ? route('ack.receipt.update', $editId) : route('ack.receipt.store') }}">
                ...
                <div class="receipt-modal-layout">
                    ...
                    <div class="receipt-preview-pane">
                            <div class="receipt-preview-content"> <div class="receipt-logo">
...
@push('scripts')
    ...
    <script>
        ...
        function generatePDF() {
            ...
            elementClone.style.width = '190mm';
